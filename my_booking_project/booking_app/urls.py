...
urlpatterns = [
    ...
    path('edit_profile/', views.edit_partner_profile, name='edit_partner_profile'),
    ...
    path('create_booking/', views.create_booking_and_redirect_to_payment, name='create_booking_and_redirect_to_payment'),
